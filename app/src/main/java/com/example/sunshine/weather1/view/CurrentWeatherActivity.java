...
import com.example.sunshine.weather1.CustomPager;
import com.example.sunshine.weather1.Entity1;
import com.example.sunshine.weather1.One;
import com.example.sunshine.weather1.R;
import com.example.sunshine.weather1.TabAdapter;
import com.example.sunshine.weather1.Two;
import com.example.sunshine.weather1.WeatherResponse;
import com.example.sunshine.weather1.WeatherViewModel;
import com.example.sunshine.weather1.databinding.ActivityCurrentWeatherBinding;
...
public class CurrentWeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentViewModel = ViewModelProviders.of(this, viewModelFactory).get(CurrentViewModel.class);

        ActivityCurrentWeatherBinding currentWeatherBinding = DataBindingUtil.setContentView(this, R.layout.activity_current_weather);
        currentWeatherBinding.setCurrentViewModel(currentViewModel);
        currentWeatherBinding.setLifecycleOwner(this);
        currentWeatherBinding.executePendingBindings();

        int cityId = getIntent().getIntExtra(CurrentWeatherActivity.extra_message, -1);
        currentViewModel.fetchWeather(cityId);
